// SYLLABUS DATABASE
// IMPORTANT: Replace the 'videoId' fields below with actual YouTube video IDs for specific videos.
...
// Copy CBSE syllabus to CHSE and append State Specific Subjects
syllabusDB['chse'] = JSON.parse(JSON.stringify(syllabusDB['cbse']));

// Override and Append CHSE Specific Science Subjects
